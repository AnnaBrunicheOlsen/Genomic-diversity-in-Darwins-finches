...
#	GenomeAnalysisTK -T DepthOfCoverage -R /scratch/snyder/a/abruenic/Darwins_finches/VCF/ref.fa -o realigned_reads \
...
cat ${LINE}_4x.hom >> /scratch/snyder/a/abruenic/Darwins_finches/individual_ROHs.txt
