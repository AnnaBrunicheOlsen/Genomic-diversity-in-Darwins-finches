...
cat ${LINE}_12x.hom >> /scratch/snyder/a/abruenic/Darwins_finches/individual_ROHs_12x.txt
...
# print to file
echo -e "$PWD\t $sites" \
>> /scratch/snyder/a/abruenic/Darwins_finches/sites_20x_coverage_12x.txt
